package com.emilio.todolist;
import com.emilio.todolist.datamodel.TodoItem;
...
//        todoListView.setItems(TodoData.getInstance().getTodoItems());
         todoListView.setItems(sortedList);    // Sorts the todo items by date.
        todoListView.getSelectionModel().setSelectionMode(SelectionMode.SINGLE); // Select only one entry.
